...
> 📌 **Importante:** Está permitido utilizar herramientas de **Inteligencia Artificial** como apoyo para la construcción del código. Sin embargo, la evaluación se centrará principalmente en la capacidad para seleccionar un análisis pertinente, interpretar los resultados obtenidos y justificar técnicamente las decisiones propuestas.
...
Proponga **un nuevo indicador** que permita identificar qué localidades deberían ser intervenidas prioritariamente.

Su respuesta debe incluir:

- **Evidencia técnica** (por ejemplo: código, tabla, estadística o visualización).
- Una explicación de máximo diez líneas indicando por qué ese indicador sería útil para la Alcaldía.
- Una recomendación concreta que podría tomarse a partir del análisis realizado.
...
Puede utilizar una o varias variables (edad, sexo, estado, localidad u otras disponibles en el dataset).

Su respuesta debe incluir:

- **Evidencia técnica** (por ejemplo: código, tabla, estadística o visualización).
- Una interpretación de los resultados obtenidos.
- Una explicación de cómo esta información podría apoyar campañas de prevención o la asignación de recursos.
...
Suponga que la Alcaldía desea determinar si una medida implementada (por ejemplo, restricciones de movilidad o cierres de localidades) produjo cambios importantes en el comportamiento de la pandemia.

Proponga un análisis exploratorio adicional que contribuya a responder esta pregunta.

Su respuesta debe incluir:

- **Evidencia técnica** (por ejemplo: código, tabla, estadística o visualización).
- Una interpretación de los resultados.
- Una explicación de qué decisión podría tomarse a partir de dicho análisis.
...
¿Cuál construiría y por qué?

Su respuesta debe incluir:

- **Evidencia técnica** (por ejemplo: código, tabla, estadística o visualización).
- Una explicación de la información que aporta la visualización.
